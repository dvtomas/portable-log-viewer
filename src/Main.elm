...
helpTexts = [
    ...
    (Debug, "USAGE Use the control panel (F2) to load your own log file and to set-up filters. Use this instructional log to learn your way around."),
    ...
    (Debug, "TODO Focus filter text input after adding new filter. Keyboard shortcuts for adding/deleting filters."),
    ...
    (Trace, "TODO IDEA Optional fixed-width font for messages"),
